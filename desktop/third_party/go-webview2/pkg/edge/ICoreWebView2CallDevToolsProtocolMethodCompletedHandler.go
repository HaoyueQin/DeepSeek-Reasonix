...
func iCoreWebView2CallDevToolsProtocolMethodCompletedHandlerInvoke(this *iCoreWebView2CallDevToolsProtocolMethodCompletedHandler, errorCode uintptr, resultObjectAsJson *uint16) uintptr {
	return this.impl.CallDevToolsProtocolMethodCompleted(errorCode, resultObjectAsJson)
}

type _ICoreWebView2CallDevToolsProtocolMethodCompletedHandlerImpl interface {
	_IUnknownImpl
	CallDevToolsProtocolMethodCompleted(errorCode uintptr, resultObjectAsJson *uint16) uintptr
}
